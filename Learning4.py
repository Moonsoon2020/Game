...
"background-color: rgb(204, 204, 204, 0);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "<html><head/><body><p align=\"center\">Отстраивайте свою базу, изучайте новые локации</p><p align=\"center\"><br/></p><p align=\"center\">И просто наслаждайтесь игрой!</p></body></html>"))
