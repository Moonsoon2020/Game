...
"background-color: rgb(204, 204, 204, 0);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-weight:600;\">В игре есть ядро, которое нужно защищать от атак.</span></p><p align=\"center\"><span style=\" font-weight:600;\">Сам персонаж стрелять не может, </span></p><p align=\"center\"><span style=\" font-weight:600;\">но когда-нибудь он научится...</span></p></body></html>"))
