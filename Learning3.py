...
"background-color: rgb(204, 204, 204, 0);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "<html><head/><body><p align=\"center\">В игре есть ресурсы, которые добываются буром.</p><p align=\"center\">С помощью зелёных стенок можно огородить своё ядро.</p><p align=\"center\">Стенки не бесконечны! </p><p align=\"center\">Поэтому Вам предстоит правильно распределить </p><p align=\"center\">как начальные ресурсы, так и последующие...</p></body></html>"))
